...
| Legacy Wine & Liquor - AI-Powered Support Email Automation with Airtable | Complete 24/7 email automation system that monitors support inbox, classifies emails with AI (order/support/other), extracts order numbers and platform info, logs to Airtable with thread deduplication, applies Gmail labels, and sends Slack notifications with urgent escalation. Includes error handling and retry logic. | Support/Operations | [Link to Template](Gmail_and_Email_Automation/Legacy%20Wine%20%26%20Liquor%20-%20AI-Powered%20Support%20Email%20Automation%20with%20Airtable.json) |
